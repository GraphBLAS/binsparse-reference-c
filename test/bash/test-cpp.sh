...
convert_ssmc() {
  ...
  time mtx2bsp-cpp ${main_matrix} ${dest_file} ${format}
  ...
  do
    ...
    time mtx2bsp-cpp ${secondary_matrix} ${dest_file}:${secondary_name}
  done
...
check_ssmc() {
  ...
  time check_equivalence-cpp ${main_matrix} ${dest_file}
  ...
  do
    ...
    time check_equivalence-cpp ${secondary_matrix} ${dest_file}:${secondary_name}
  done
